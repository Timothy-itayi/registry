  ...
  return (
    <Card className={`border-2 border-amber-200 bg-[#FADA7A] ${className}`}>
      <CardHeader className="text-center ">
        ...
        <CardTitle className="text-2xl header text-[#3674B5]">A Message from Timothy & Gracie</CardTitle>

      </CardHeader>
      <CardContent className="text-center">
        <p className="text-black text-md paragraph-message leading-relaxed mb-4">
        ...
        <p className="text-[#D72631] message ">
